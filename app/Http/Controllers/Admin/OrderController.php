...
class OrderController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $order = Order::select('orders.id', 'orders.user_id', 'orders.address', 'orders.delivery', 'orders.comment', 'orders.status', 'order_product.count', 'orders.total_price', 'orders.created_at', 'users.phone as user_phone', 'users.email as user_email', 'users.name as user_name', 'products.name as product_name', 'products.price as product_price')
            ->join('users', 'users.id', '=', 'orders.user_id')
