...
Route::get('/client/video/create/{id}', [\App\Http\Controllers\Client\VideoController::class, 'create'])->middleware('auth')->name('client-video-create');
Route::get('/client/video/destroy/{id}', [\App\Http\Controllers\Client\VideoController::class, 'destroy'])->middleware('auth')->name('client-video-destroy');
Route::post('/client/video/save', [\App\Http\Controllers\Client\VideoController::class, 'save'])->middleware('auth')->name('client-video-save');
