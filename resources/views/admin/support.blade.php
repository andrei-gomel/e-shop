         ...
         <div class="header-nav__body">
             ...
             <ul class="header-nav__menu">
                 ...
                 {{--<li class="header-nav__video">
                     <a href="/admin/video/show/{{ $client_id }}">
                         <svg>
                 ...
                 <li class="header-nav__btns">
                     ...
                     <a href="/admin/button/{{ $client_id }}">
                         <svg>
                             <use xlink:href="/img/nav.svg#btns"></use>
                         </svg>
                         Кнопка связи
                     </a>
                 </li>--}}
                 ...
                 <li class="header-nav__support active">
                     <a href="/admin/ticket/view/{{--{{ $client_id }}--}}">
                         <svg>
            ...
            <div class="_container">
               <div class="page-header__body">
                  ...
                  <div class="page-header__actions">
                     ...
                     <a href="/admin/ticket/create" class="btn btn__main">Добавить тикет</a>
...
@if(count($ticketsList) > 0)
    @foreach($ticketsList as $item)
                     ...
                     <tr>
                        ...
                        <td>
                           <div>
                              <a href="/admin/ticket/show/{{$item->id}}">
