...
<head>
    ...
    <title>E-shop | Кабинет пользователя | Просмотр заказа</title>
</head>
<body>
@guest()
            ...
            <div class="page-header">
                <div class="_container">
                    <div class="page-header__body">
                        <h1 class="page-header__title">{{ __('Личный кабинет / Просмотр заказа №') }}{{ $order[0]->id }}</h1>
                ...
                <div class="table-responsive">
                    <table class="table with-action">
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="{{ route('client-orders-edit', $order[0]->id) }}">
                                        <svg><use xlink:href="/img/sprite.svg#arrow"></use></svg></a>
                                    <a href="{{ route('client-order-delete', $order[0]->id) }}"><svg><use xlink:href="/img/sprite.svg#close"></use></svg></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
