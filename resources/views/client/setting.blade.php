...
<head>
    ...
    <title>E-shop | Кабинет пользователя | Редактирование данных пользователя</title>
</head>
            ...
            <div class="page-header">
                <div class="_container">
                    <div class="page-header__body">
                        <h1 class="page-header__title">{{ __('Личный кабинет') }}
                            ({{$user->name}})</h1>
                ...
                <div class="add-new__header">
                    <div class="_container">
                        <div class="add-new__header-body">
                                ...
                                <h3 class="add-new__title">{{ __('Редактирование личных данных') }}</h3>
